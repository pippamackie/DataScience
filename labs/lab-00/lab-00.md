...
nums <- c(18, NA, 12, NA, NA) #Extend if necessary
colours <- c("powderblue", "Colour 1", "coral", "colour 2", "colour 4") #Extend if necessary
hobbies <- c("Hiking", "Hobby 1", "reading", "Hobby 3", "Hobby 4") #Extend if necessary
